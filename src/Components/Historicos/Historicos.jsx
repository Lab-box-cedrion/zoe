  ...
  return (
    <Fragment>
      ...
      <article className="content">
        <h1 className="title">Históricos</h1>
        <p className="about-historicos">
          Archivo de los experimentos. Se puede buscar por día y hora o nombre
          elegido. Ordenados de más reciente a más antiguo. Seleccionando uno de
          los campos se accederá a una vista resumen de los resultados y
          seleccionando cada uno de ellos a su vez se visualiza la gráfica de
          los resultados.
        </p>
        ...
        >
          <span className="p-float-label portfield">
            <InputText
              id="in"
              value={form.puerto}
              onChange={(e) => setValue({ ...form, puerto: e.target.value })}
            />
          ...
          <span className="p-float-label timefield">
            <InputText
              id="in"
              value={form.segundos}
              onChange={(e) => setValue({ ...form, segundos: e.target.value })}
            />
